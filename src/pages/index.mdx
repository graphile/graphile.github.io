...
<div class='df flex-row justify-center' style={{height: '3rem'}}>
  <div class='ph2 df flex-column justify-center'>
  <a class='button--outline' href='https://postgraphile.org/postgraphile/current/'><span class='fas fa-book-open' /> V4 Documentation</a>{ ' '}
  </div>
  <div class='ph2 df flex-column justify-center'>
  <a class='button--solid' href='https:///postgraphile.org'>PostGraphile.org</a>{ ' '}
  </div>
