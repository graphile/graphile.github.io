...
<div class='flex'>
<a class='button--solid-light' href='/postgraphile/introduction/'><span class='fas fa-book-open' /> Documentation <span class='fas fa-fw fa-arrow-right' /></a>
</div>
<div class='flex'>
<div style={{margin: '0 0.5rem 0 0'}}><a class='button--solid' href='https://discord.gg/graphile'><span class='fab fa-discord' /> Join Chat</a></div>
<div style={{margin: '0 0.5rem 0 0'}}><a class='button--solid' href='https://github.com/graphile/postgraphile'><span class='fas fa-star' /> View on GitHub</a></div>
</div>
...
['GraphQL best practices', 'Including: [cursor pagination](https://facebook.github.io/relay/graphql/connections.htm), [global object identification](https://facebook.github.io/relay/graphql/objectidentification.htm), and [Relay mutations](https://relay.dev/docs/en/mutations)'],
