...
using [subscriptions](/postgraphile/subscriptions/), or keeping live queries to
a very small area of your application.
...
customise these if you wish using
[the inflection system](/postgraphile/inflection/).
