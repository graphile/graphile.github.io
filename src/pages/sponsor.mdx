...
<Sponsor name="Open Law NZ" business avatar={openlaw} />
...
<Sponsor name="plus 49 more backers..." plain />
</Sponsors>
...
Our preferred sponsorship provider is currently GitHub since they are waiving all fees and match-funding up to $5000/yr for the first year:

<div class='tc'>
<a class='button--solid' href='https://github.com/users/benjie/sponsorship'>Fee-free match-funded sponsorship via GitHub Sponsors <span class='fas fa-fw fa-external-link-square-alt' /></a>
</div>


If you prefer, you may instead sponsor us [via
Patreon](https://www.patreon.com/bePatron?u=7308310). If you wish to sponsor
