...
Grafast is currently only available to Graphile sponsors as it is still
undergoing heavy iteration; sign up as a sponsor to get access to the binaries
and documentation (sponsor at the Featured Tier for access to the repository,
issues and support!)
...
<Sponsors level="leaders">
  ...
  <Sponsor name="Ayog Healthcare" avatar="/images/sponsors/Ayog.png" business />
  <Sponsor name="Severin Ibarluzea" />
</Sponsors>
<Sponsors level="supporters">
  ...
  <Sponsor name="liteflow-labs" />
</Sponsors>
<Sponsors level="backers">
  <Sponsor name="plus 58 more backers..." plain />
</Sponsors>
