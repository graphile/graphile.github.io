...
<MarketingDivide from="white" to="light" />
...
progresses to make it appropriate for a wide range of use-cases.

To make PostGraphile a project that users can rely on for years to come, it
needs to be well directed and financially sustainable. The absolute best way
to support PostGraphile’s ongoing development efforts, the most
bang-for-your-buck as it were, is to become a Patreon sponsor. Crowd-sourced
funding enables us to spend the most time directly working on improving
PostGraphile, which you and other PostGraphile users then benefit from.
