...
✨**NEW for Winter 2019**✨The Standard Plan now includes 3 x 30 minute screensharing calls each month, which allows for important one-on-one time with the maintainer of the PostGraphile software.
...
is available for an hourly rate. The Budget Plan does not include any screensharing calls.
