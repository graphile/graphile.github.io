...
Price: from $1,500/month, paid monthly through GitHub sponsors, or
quarterly/annually through invoicing (+ VAT where applicable).
</div>
...
<div className="f4 tl" style={{maxWidth: '50rem', margin: '0 auto'}}>
Price: from $6,000/month, cancel any time, no minimum term.

*\* T&Cs apply - prices quoted for teams containing up to 10 engineers - 
calls may be up to 3 hours, at most one per day, booked on a first-come 
first-served basis - pay monthly through GitHub Sponsors, or through 
...
On [our Discord chat](http://discord.gg/graphile), members are given colourful
...
members with colourful name badges.
